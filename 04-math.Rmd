...
_Last update: `r system("git log -1 --format=\"%ad (%h)\" -- 04-math.Rmd", intern = TRUE)`_
...
```{python, overlapping-fun, decorate=TRUE}
...
```{python, wireframe, decorate=TRUE}
